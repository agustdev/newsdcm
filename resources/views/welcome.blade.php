...
<html lang="es">
    ...
    <body>
        ...
        <div class="hidden md:block">
                ...
                <div class="md:hidden flex flex-col">
                    ...
                    <div class="simbol flex items-center">
                        <a class="md:hidden" href="#">
                            <img src="{{ asset('images/logo armada.png') }}" alt="Logo" width="150"
                                height="24" class="inline align-top mx-1" />
                        </a>

                        <a class="md:hidden" href="#">
                            <img src="{{ asset('images/capitania_web.png') }}" alt="Logo" width="200"
                                height="24" class="inline align-top mx-1" />
                        </a>
                    </div>
                </div>
                ...
                <div class="md:container items-center flex justify-between mx-auto py-3">
                    <div class="flex items-center">
                        ...
                        <a class="hidden md:block" href="#">
                            <img src="{{ asset('images/logo armada.png') }}" alt="Logo" width="250"
                                height="24" class="inline align-top" />
                        </a>

                        <a class="hidden md:block" href="#">
                            <img src="{{ asset('images/capitania_web.png') }}" alt="Logo" width="300"
                                height="24" class="inline align-top" />
                        </a>
                    ...
                    <nav
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <div class="hidden lg:flex lg:items-center gap-x-2">
                                ...
                                @else
                                    <a href="{{ route('login') }}"
                                        class="flex items-center text-white dark:text-white justify-center px-6 py-2.5 font-semibold hover:underline hover:underline-offset-4 hover:w-fit">{{ __('Iniciar Sesión') }}</a>
            ...
            <section>
                ...
                <div class="container flex justify-center items-center w-full mt-3 mb-10 mx-auto">
                    <a href="#section"
                        class="animate__animated animate__bounce animate__infinite animate__slower"><svg
                ...
                <div class="container mx-auto md:hidden grid grid-cols-1">
                    ...
                    <div class="flex px-3 py-3">
                        <div class="rounded overflow-hidden shadow-lg">
                            ...
                            <div class="px-6 py-4">
                                <div class="font-bold text-sm mb-2">{{ __('Conduce y Despacho de embarcaciones') }}
                                </div>
                                <p class="text-gray-700 text-sm justificado">
        ...
        <div class="md:hidden bg-blue-950 h-screen">
                ...
                <div class="bg-blue-300 text-white ">
                    ...
                    <div>
                        <div id="animation-carousel" class="relative w-full" data-carousel="slide">
                            <!-- Carousel wrapper -->
                            <div class="relative h-56 overflow-hidden bg-blue-950 md:h-96">
                                ...
                                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                                    <img src="{{ asset('images/star.png') }}"
                                        ...
                                        alt="...">
                                    <p class="text-center -mb-4 mt-3 font-bold">{{ __('Servicio') }}</p>
                                </div>
                                <!-- Item 2 -->
                                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                                    <img src="{{ asset('images/soldier.png') }}"
                                        class="absolute block max-w-[150px] lg:max-w-[250px] object-contain h-48 w-48 -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
                                        alt="...">
                                    <p class="text-center -mb-4 mt-3 font-bold">{{ __('Asistencia') }}</p>
                                </div>
            ...
            <button type="button" class="absolute bg-blue-900 top-0 end-0 z-30 flex items-center justify-center h-full px-4 cursor-pointer group focus:outline-none" data-carousel-next>
                <span class="inline-flex items-center justify-center w-10 h-10 rounded-full bg-white/30 dark:bg-gray-800/30 group-hover:bg-white/50 dark:group-hover:bg-gray-800/60 group-focus:ring-4 group-focus:ring-white dark:group-focus:ring-gray-800/70 group-focus:outline-none">
                    ...
                    <div class="bg-blue-950 flex justify-center">
                        @auth
                        <a href="{{ route('redireccion') }}"
                        ...
                        @else
                            <a href="{{ route('login') }}"
                                class="px-8 py-4 text-white bg-blue-500 font-bold rounded-full transition-transform transform-gpu hover:-translate-y-1 hover:shadow-lg hover:bg-blue-600">
                                {{ __('Iniciar Sesión o Registrarse') }}
                            </a>
                        @endauth
                    </div>
                </div>
