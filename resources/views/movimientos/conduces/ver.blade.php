                ...
                <div class="card-body">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-2">
                        ...
                        <div class="">
                            ...
                            <span
                                class="header-title col-md-2 d-inline">{{ $conduce->created_at->format('d-m-Y') }}</span>
                        </div>
                        <div class="">
                            <span
                                class="header-title  col-md-2 d-inline text-black"><strong>{{ __('Estatus') }}:</strong></span>
        ...
        <div class="card-body">
                ...
                <h4 class="header-title">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-2">
                        ...
                        <div class="">
                            ...
                            <span class="">{{ str_replace('|', ', ', $conduce->conductor->telefono) }}</span>
                        </div>
                        <div class="">
                            <p class="header-title d-inline text-black">
            ...
            @if (!empty($conduce->vehiculo))
                <h4 class="header-title mt-3">
                    <div class=" text-black text-sm font-bold mb-2"><i class="mdi mdi-car-back"></i>
        ...
        <div class="card-footer">
            <div class="float-end">
                ...
                @if (!in_array($conduce->estado, $estados))
                    <form target="_blank" method="POST" action="{{ route('movimientos.pdf', $conduce) }}"
                        class="d-inline">
                        @csrf
                        <button type="submit"
