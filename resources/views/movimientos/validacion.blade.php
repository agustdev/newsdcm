<x-guest-layout>
    ...
    <div class="row">
        <h2 class="h2">{{ __('Validación de Solicitud') }}</h2>
        <div class="col-xl-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <h5 class="header-title"><strong>Fecha Solicitud:</strong>
                        {{ $solicitud->created_at->format('d-m-Y') }}</h5>
                    <h5 class="header-title border-bottom py-2"><strong>Estatus:</strong>
                        @if ($solicitud->estado == 'Aprobado')
                            <span
                                class="bg-green-100 text-green-600 text-sm font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-green-700 dark:text-green-300">{{ $solicitud->estado }}</span>
                        @elseif ($solicitud->estado == 'Rechazado' or $solicitud->estado == 'Cancelado')
                            <span
                                class="bg-red-100 text-red-600 text-sm font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-red-700 dark:text-red-300">{{ $solicitud->estado }}</span>
                        @elseif ($solicitud->estado == 'Enviado')
                            <span
                                class="bg-yellow-100 text-yellow-600 text-sm font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-yellow-700 dark:text-yellow-300">{{ $solicitud->estado }}</span>
                        @elseif ($solicitud->estado == 'En proceso')
                            <span
                                class="bg-blue-100 text-blue-600 text-sm font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-blue-700 dark:text-blue-300">{{ $solicitud->estado }}</span>
                        @endif
                    </h5>
                    ...
                    <h4 class="header-title mt-3">
                        ...
                        <p class="mt-2">
                            ...
                            {{ $solicitud->embarcacion->capacidad_tripulantes }}
                        </p>
                        <p class="mt-2">
                        ...
                        @if (!empty($solicitud->capitan))
                            <h4 class="header-title mt-3">
                                ...
                                <p class="mb-2 mt-2">
                                    ...
                                    {{ !empty($solicitud->capitan) ? $solicitud->capitan->nombre : '' }}
                                </p>
                                <p class="mb-2 mt-2">
                                ...
                                <p class="mb-2 mt-2 py-2">
                                    ...
                                    {{ !empty($solicitud->capitan) ? $solicitud->capitan->motivo_viaje : '' }}
                                </p>
                                <p>
                                ...
                                <p class="mb-2 mt-2">
                                    ...
                                    {{ !empty($solicitud->capitan) ? $solicitud->capitan->lugar_salida : '' }}
                                </p>
                                <p class="mb-2 mt-2">
                                    <strong>Lugar destino:</strong>
                                    {{ !empty($solicitud->capitan) ? $solicitud->capitan->lugar_destino : '' }}
                                </p>
                            </h4>
                        @else
