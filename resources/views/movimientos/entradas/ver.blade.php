        ...
        <div class="col-xl-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <h5 class="header-title"><strong>Fecha Solicitud:</strong> {{ $entrada->created_at->format('d-m-Y')
                        }}</h5>
                    ...
                    <h4 class="header-title mt-3">
                        ...
                        <p class="mb-2 mt-2">
                            <strong>Nombre:</strong> {{ !empty($entrada->capitan) ? $entrada->capitan->nombre : '' }}
                        </p>
                        <p class="mb-2 mt-2">
                            <strong>Documento:</strong> {{ !empty($entrada->capitan) ? $entrada->capitan->documento :
                            '' }}
                        </p>
                        <p class="mb-2 mt-2">
                            <strong>Teléfono:</strong> {{ !empty($entrada->capitan) ? $entrada->capitan->telefono : ''
                            }}
                        </p>
                        <p class="mb-2 mt-2 py-2">
                            <strong>Motivo del viaje:</strong> {{ !empty($entrada->capitan) ?
                            $entrada->capitan->motivo_viaje : '' }}
                        </p>
                        <p>
                        ...
                        <p class="mb-2 mt-2">
                            <strong>Lugar salida:</strong> {{ !empty($entrada->capitan) ?
                            $entrada->capitan->lugar_salida : '' }}
                        </p>
                        <p class="mb-2 mt-2">
                            <strong>Lugar destino:</strong> {{ !empty($entrada->capitan) ?
                            $entrada->capitan->lugar_destino : '' }}
                        </p>
                    </h4>
                    @else
                ...
                <div class="card-footer">
                    <div class="float-end">
                        ...
                        <a href="{{ route('pdf.eticket', $entrada) }}"
                            class="inline-flex items-center justify-center px-4 py-2 bg-red-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-red-500 active:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 transition ease-in-out duration-150">E-TICKET</a>
                        @endif
                        @php
