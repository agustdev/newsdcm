        ...
        <div class="row">
            ...
            <div class="col-md">
                <div class="form-floating mb-2">
                    ...
                    <label style="font-size: 10px;" for="floatingFecha">FECHA LLEGADA</label>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md">
                <div class="form-floating mb-2">
                    ...
                    <label style="font-size: 10px;" for="floatingPais">PAIS PROCEDENCIA</label>
                </div>
            </div>
            <div class="col-md">
                <div class="form-floating mb-2">
            ...
            <div class="col-md">
                <div class="form-floating mb-2">
                    ...
                    <label style="font-size: 10px;" for="floatingPuertoLlegada">PUERTO DE LLEGADA</label>
                </div>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-md">
                <div class="form-floating mb-2">
                    ...
                    <label style="font-size: 10px;" for="floatinMatricula">TIEMPO DE ESTADIA</label>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="card-footer">
        <div class="float-end">
            <a href="{{ route('movimientos.despachos.index') }}"
                class="inline-flex items-center px-3 py-2 bg-slate-300 border border-transparent rounded-md font-semibold text-xs text-black uppercase tracking-widest hover:bg-slate-400 focus:bg-slate-500 active:bg-slate-600 focus:outline-none focus:ring-2 focus:ring-slate-700 focus:ring-offset-2 transition ease-in-out duration-150 ml-1">Atras</a>
            <button type="submit"
...
{{-- fin de datos de los tripulantes  --}}
