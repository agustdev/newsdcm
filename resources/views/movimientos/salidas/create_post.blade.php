<x-app-layout>
    ...
    <div class="row g-2">
        <div class="alert alert-info">
            <i class="uil-info-circle"></i> Este formulario solo es para embarcaciones que se dirigen a otros paises
        </div>
    </div>
    {{-- formulario de solicitud de despacho --}}
    <div class="row g-2">
        <form action="{{ route('movimientos.salidas.store') }}" method="POST" class="form-inline uppercase"
            autocomplete="off">
            @csrf
                    ...
                    <div class="row g-2">
                        <div class="col-md">
                            <div class="form-floating">
                                <input type="text" class="form-control matricula rounded-md uppercase"
                                    id="floatinMatricula" placeholder="MATRICULA" name="matricula" required
                                    value="{{ $embarcacion->matricula }}"
                                    {{ !empty($embarcacion->matricula) ? 'readonly' : '' }} />
                                <label style="font-size: 10px;" for="floatinMatricula">{{ __('MATRÍCULA') }}</label>
                            </div>
                        </div>
                        <div class="col-md">
                            <div class="form-floating">
                                <input type="text" class="form-control nombre_emb rounded-md uppercase"
                                    id="floatingNombreEmbarcacion" placeholder="NOMBRE DE LA EMBARCACIÓN" name="nombre"
                                    required value="{{ $embarcacion->nombre }}"
                                    {{ !empty($embarcacion->nombre) ? 'readonly' : '' }} />
                        ...
                        <div class="col-md">
                            <div class="form-floating">
                                <input type="text" class="form-control numero_casco rounded-md uppercase"
                                    id="floatingNumeroCasco" placeholder="NUMERO DE CASCO" name="numero_casco" required
                                    value="{{ $embarcacion->no_chasis }}"
                                    {{ !empty($embarcacion->no_chasis) ? 'readonly' : '' }} />
                                <label style="font-size: 10px;"
                        ...
                        <div class="col-md">
                            <div class="form-floating">
                                <input type="text" class="form-control color rounded-md uppercase" id="floatingColor"
                                    placeholder="COLOR DE LA EMBARCACIÓN" name="color" required
                                    value="{{ $embarcacion->color }}"
                                    {{ !empty($embarcacion->color) ? 'readonly' : '' }} />
                        ...
                        <div class="col-md">
                            <div class="form-floating">
                                <input type="text" name="material_casco" class="form-control rounded-md"
                                    ...
                                    value="{{ $embarcacion->material_casco }}"
                                    {{ !empty($embarcacion->material_casco) ? 'readonly' : '' }} />
                                <label style="font-size: 10px;"
                        ...
                        <div class="col-md">
                            <div class="form-floating">
                                <input type="number" class="form-control eslora rounded-md" id="floatinEslora"
                                    ...
                                    value="{{ !empty($embarcacion->eslora) ? $embarcacion->eslora : $embarcacion->pies_eslora }}"
                                    {{ (!empty($embarcacion->eslora) ? 'readonly' : !empty($embarcacion->pies_eslora)) ? 'readonly' : '' }} />
                        ...
                        <div class="col-md">
                            <div class="form-floating">
                                <input type="number" class="form-control nombre_emb rounded-md" id="floatingManga"
                                    ...
                                    value="{{ !empty($embarcacion->manga) ? $embarcacion->manga : $embarcacion->pies_manga }}"
                                    {{ (!empty($embarcacion->manga) ? 'readonly' : !empty($embarcacion->pies_manga)) ? 'readonly' : '' }} />
                        ...
                        <div class="col-md">
                            <div class="form-floating">
                                <input type="number" class="form-control puntal rounded-md" id="floatingPuntal"
                                    ...
                                    value="{{ !empty($embarcacion->puntal) ? $embarcacion->puntal : $embarcacion->pies_puntual }}"
                                    {{ (!empty($embarcacion->puntal) ? 'readonly' : !empty($embarcacion->pies_puntual)) ? 'readonly' : '' }} />
                        ...
                        <div class="col-md">
                            <div class="form-floating mb-2">
                                <select name="tipo_embarcacion" id="" class="form-select rounded-md"
                                    required {{ !empty($embarcacion->tipo_embarcacion) ? 'disabled' : '' }}>
                                    <option value="">- {{ __('Seleccione') }} -</option>
                                    <option {{ $embarcacion->tipo_embarcacion == 'CATAMARAN' ? 'selected' : '' }}
                                        value="CATAMARAN">
                                        {{ __('CATAMARAN') }}</option>
                                    <option {{ $embarcacion->tipo_embarcacion == 'VELERO' ? 'selected' : '' }}
                                        value="VELERO">{{ __('VELERO') }}
                                    </option>
                                    <option {{ $embarcacion->tipo_embarcacion == 'YATE' ? 'selected' : '' }}
                                        value="YATE">{{ __('YATE') }}
                                    </option>
                                    @if (!empty($embarcacion->tipo_embarcacion))
                                        <option selected value="{{ $embarcacion->tipo_embarcacion }}">
                                ...
                                <input type="hidden" name="tipo_embarcacion"
                        ...
                        <div class="col-md">
                            <div class="form-floating mb-2">
                                <select name="tipo_uso" id="" class="form-select rounded-md" required
                                    {{ !empty($embarcacion->tipo_uso) ? 'disabled' : '' }}>
                                    <option value="">- {{ __('Seleccione') }} -</option>
                                    <option {{ $embarcacion->tipo_uso == 'ARTEFACTO NAVAL' ? 'selected' : '' }}
                                        value="ARTEFACTO NAVAL">ARTEFACTO NAVAL</option>
                                    <option {{ $embarcacion->tipo_uso == 'CARGA SECA' ? 'selected' : '' }}
                                        value="CARGA SECA">CARGA SECA</option>
                                    <option {{ $embarcacion->tipo_uso == 'DRAGA' ? 'selected' : '' }} value="DRAGA">
                                        DRAGA</option>
                                    <option {{ $embarcacion->tipo_uso == 'DEPORTIVA' ? 'selected' : '' }}
                                        value="DEPORTIVA">DEPORTIVA</option>
                                    <option {{ $embarcacion->tipo_uso == 'ESPECIAL' ? 'selected' : '' }}
                                        value="ESPECIAL">ESPECIAL</option>
                                    <option {{ $embarcacion->tipo_uso == 'LANCHA PRACTICO' ? 'selected' : '' }}
                                        value="LANCHA PRACTICO">LANCHA PRÁCTICO</option>
                                    <option {{ $embarcacion->tipo_uso == 'PESCA' ? 'selected' : '' }} value="PESCA">
                                        PESCA</option>
                                    <option {{ $embarcacion->tipo_uso == 'PLATAFORMA' ? 'selected' : '' }}
                                        value="PLATAFORMA">PLATAFORMA</option>
                                    <option {{ $embarcacion->tipo_uso == 'RECREATIVA' ? 'selected' : '' }}
                                        value="RECREATIVA">RECREATIVA</option>
                                    <option {{ $embarcacion->tipo_uso == 'RECREO' ? 'selected' : '' }} value="RECREO">
                                        {{ __('RECREO') }}</option>
                                    <option {{ $embarcacion->tipo_uso == 'REMOLCADOR' ? 'selected' : '' }}
                                        value="REMOLCADOR">REMOLCADOR</option>
                                    <option {{ $embarcacion->tipo_uso == 'TANQUERO' ? 'selected' : '' }}
                                        value="TANQUERO">TANQUERO</option>
                                    <option {{ $embarcacion->tipo_uso == 'TURISTICO' ? 'selected' : '' }}
                                        value="TURISTICO">{{ __('TURÍSTICO') }}</option>
                                    <option {{ $embarcacion->tipo_uso == 'TURISTICO COMERCIAL' ? 'selected' : '' }}
                                        value="TURISTICO COMERCIAL">{{ __('TURÍSTICO COMERCIAL') }}</option>
                                    <option {{ $embarcacion->tipo_uso == 'TURISTICO PRIVADO' ? 'selected' : '' }}
                                        value="TURISTICO PRIVADO">{{ __('TURÍSTICO PRIVADO') }}</option>
                                    <option {{ $embarcacion->tipo_uso == 'OTRO DESTINO' ? 'selected' : '' }}
                                        value="OTRO DESTINO">OTRO DESTINO</option>
                                    @if (!empty($embarcacion->tipo_uso))
                                        <option selected value="{{ $embarcacion->tipo_uso }}">
                                            {{ $embarcacion->tipo_uso }}
                                        </option>
                                    @endif
                                </select>
                                <label style="font-size: 10px;"
                                    for="floatingEmbarcacion">{{ __('TIPO DE USO') }}</label>
                                <input type="hidden" name="tpo_uso" value="{{ $embarcacion->tipo_uso }}">
                            </div>
                        </div>
                    </div>
                    <div class="row g-2">
                        ...
                        <div class="col-md">
                            <div class="form-floating mb-2">
                                <input type="text" name="tipo_motor" class="form-control rounded-md uppercase"
                                    placeholder="TIPO MOTOR" required
                                    value="{{ !empty($embarcacion->tipo_motor) ? $embarcacion->tipo_motor : '' }}"
                                    {{ !empty($embarcacion->tipo_motor) ? 'readonly' : '' }}>
                                <label style="font-size: 10px;" for="floatinTipoMotor">{{ __('TIPO MOTOR') }}</label>
                            </div>
                        </div>
                        <div class="col-md">
                            <div class="form-floating mb-2">
                                <input type="text" name="marca_modelo_motor"
                                    class="form-control rounded-md uppercase" placeholder="MARCA MOTOR" required
                                    value="{{ !empty($embarcacion->marca_modelo_motor) ? $embarcacion->marca_modelo_motor : '' }}"
                                    {{ !empty($embarcacion->marca_modelo_motor) ? 'readonly' : '' }}>
                                <label style="font-size: 10px;"
                        ...
                        <div class="col-md">
                            <div class="form-floating mb-2">
                                <input type="text" name="caballos_fuerza_motor" class="form-control rounded-md"
                                    ...
                                    value="{{ !empty($embarcacion->caballos_fuerza_motor) ? $embarcacion->caballos_fuerza_motor : '' }}"
                                    {{ !empty($embarcacion->caballos_fuerza_motor) ? 'readonly' : '' }}>
                                <label style="font-size: 10px;"
                        ...
                        <div class="col-md">
                            <div class="form-floating mb-2">
                                <input type="text" name="no_motor" class="form-control rounded-md"
                                    ...
                                    value="{{ !empty($embarcacion->no_motor) ? $embarcacion->no_motor : '' }}"
                                    {{ !empty($embarcacion->no_motor) ? 'readonly' : '' }} />
                                <label style="font-size: 10px;"
