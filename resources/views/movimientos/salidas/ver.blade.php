            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <h4 class="header-title mt-3">
                        ...
                        <p class="mb-2 mt-2">
                            <strong>Documento:</strong> {{ !empty($salida->capitan) ? $salida->capitan->documento :
                            '' }}
                        </p>
                        <p class="mb-2 mt-2">
                            <strong>Teléfono:</strong> {{ !empty($salida->capitan) ? $salida->capitan->telefono : ''
                            }}
                        </p>
                        <p class="mb-2 mt-2 py-2">
                            <strong>Motivo del viaje:</strong> {{ !empty($salida->capitan) ?
                            $salida->capitan->motivo_viaje : '' }}
                        </p>
                        <p>
                        ...
                        <p class="mb-2 mt-2">
                            <strong>Lugar salida:</strong> {{ !empty($salida->capitan) ?
                            $salida->capitan->lugar_salida : '' }}
                        </p>
                        <p class="mb-2 mt-2">
                            <strong>Lugar destino:</strong> {{ !empty($salida->capitan) ?
                            $salida->capitan->lugar_destino : '' }}
                        </p>
                    </h4>
                    @else
