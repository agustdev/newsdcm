            ...
            <div class="card shadow-xl">
                ...
                <div class="card-body">
                        ...
                        <div class="col-md">
                            <div class="form-floating mb-2">
                                <input type="datetime-local" class="form-control rounded-md" id="floatingFecha"
                                    placeholder="FECHA" name="fecha" min="{{ date('Y-m-d') . 'T06:00' }}"
                        ...
                        <div class="col-md">
                            <div class="form-floating mb-2">
                                <input type="datetime-local" class="form-control rounded-md" id="floatingFechaArribo"
                                    ...
                                    max="{{ date('Y-m-d', strtotime('+10 Days')) . 'T18:00' }}" />
                                <label style="font-size: 10px;"
                                    for="floatingFechaArribo">{{ __('FECHA Y HORA DE ARRIBO') }}</label>
                            </div>
                        </div>
                        <div class="col-md">
                            <div class="form-floating mb-2">
                    ...
                    <div class="row g-2">
                        <div class="col-md">
                            <div class="form-floating mb-2">
                                <input type="number" class="form-control rounded-md"
                                    ...
                                    name="cantidad_tripulantes" min="1"
                                    max="{{ $embarcacion->capacidad_tripulantes }}" value="0" />
                                <label style="font-size: 10px;"
                        ...
                        <div class="col-md">
                            <div class="form-floating mb-2">
                                <input type="number" class="form-control rounded-md" id="floatingCantidadPasajeros"
                                    placeholder="CANTIDAD DE PASAJEROS" name="cantidad_pasajeros" min="1"
                                    max="{{ $embarcacion->capacidad_personas }}" value="0" />
                                <label style="font-size: 10px;"
