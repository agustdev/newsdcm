    ...
    <div class="col-lg-12">
        <h3 class="h4 uppercase">{{ __('Número de solicitud') }}:
            ...
            <div class="card">
                ...
                {{-- termina el header de la tarjeta --}}
                {{-- Comienza el cuerpo de la tarjeta --}}
                <div class="card-body">
                    <div class="row g-2">
                        ...
                        <div class="col-md">
                            <div class="form-floating mb-1">
                                ...
                                <select style="font-size: 13px;" name="matricula" class="form-select emb_matricula rounded-md" id="floatinMatricula">
                                ...
                                <label style="font-size: 14px;" for="floatinMatricula">{{ __('MATRÍCULA') }}</label>
                            </div>
                        </div>
                        <div class="col-md">
                            <div class="form-floating mb-1">
                        ...
                        <div class="col-md">
                            <div class="form-floating mb-1">
                                ...
                                <label style="font-size: 10px;" for="floatingNumeroCasco">NÚMERO DE CASCO</label>
                            </div>
                        </div>
                        <div class="col-md">
                         ...
                         {{-- <span
                            ...
                            {{-- recordar que antes tenia un row --}}
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-2">
                            {{-- recordar que antes tenia un row --}}
                           {{-- ahora quitare los col-md para ver si soluciono lo que quiero --}}
                            <div class="">
                                <div class="form-floating">
