        ...
        <div class="col-xl-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <h5 class="header-title"><strong>Fecha Solicitud:</strong> {{ $despacho->created_at->format('d-m-Y')
                        }}</h5>
                    ...
                    <h4 class="header-title mt-3">
                        ...
                        <p class="mb-2 mt-2 py-2">
                            <strong>Motivo del viaje:</strong> {{ !empty($despacho->capitan) ?
                            $despacho->capitan->motivo_viaje : '' }}
                        </p>
                        <p>
                            <strong>Fecha Salida:</strong>
                            {{ $despacho->fecha->format('d-m-Y') }}
                        </p>
                        <p class="mb-2 mt-2">
                            <strong>Lugar salida:</strong> {{ !empty($despacho->capitan) ?
                            $despacho->capitan->lugar_salida : '' }}
                        </p>
                        <p class="mb-2 mt-2">
                            <strong>Lugar destino:</strong> {{ !empty($despacho->capitan) ?
                            $despacho->capitan->lugar_destino : '' }}
                        </p>
                    </h4>
                    @else
