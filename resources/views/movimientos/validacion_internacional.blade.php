    ...
    <body class="bg-blue-950">
        ...
        <div class="container mx-auto">
            ...
            <div class="card mt-2 mb-2 shadow-xl">
                <div class="card-header bg-slate-200">
                    <span class=""><strong>{{ __('Información de la embarcación') }}</strong></span>
                </div>
                <div class="card-body">
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-2">
                        <div class="">
                        ...
                        <div class="">
                            <span class="header-title d-inline text-black"><strong>Nombre de la
                                    embarcación:</strong></span>
            ...
            @if ($solicitud->tipo_movimiento == 'D')
                ...
                <div class="card">
                    <div class="card-header bg-slate-200">
                        <span class=""><strong>Información del capitán</strong></span>
                    </div>
                    <div class="card-body">
            ...
            @endif
            @if ($solicitud->tipo_movimiento == 'C')
                {{-- informacion del conductor --}}
                <div class="card">
                    <div class="card-header bg-slate-200">
                        <span class=""><strong>Información del Conductor</strong></span>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-3 gap-2">
                            ...
                            <div class="">
                                ...
                                <span
                                    class="">{{ !empty($solicitud->conductor) ? str_replace('|', ', ', $solicitud->conductor->telefono) : '' }}</span>
                ...
                <div class="card">
                    <div class="card-header">
                        <span class=""><strong>Datos del Vehículo</strong></span>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-3 gap-2">
                            ...
                            <div class="">
                                ...
                                <span
                                    class="ml-2">{{ !empty($solicitud->vehiculo) ? $solicitud->vehiculo->year : '' }}</span>
                            </div>
                            <div class="">
                            ...
                            <div class=r">
                                ...
                                <span
                                    class="ml-2">{{ !empty($solicitud->vehiculo) ? $solicitud->vehiculo->calle : '' }}
                                </span>
                            </div>
