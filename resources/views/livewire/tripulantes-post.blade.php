<div class="row tripulantes">
    ...
    <div class="col-md">
        <div class="form-floating mb-2">
            <input wire:model.defer='documento' type="text" class="form-control nacionalidad rounded-md"
                id="floatinMatricula" placeholder="name@example.com" name="documento" value=""
    ...
    <div class="col-md">
        <div class="form-floating mb-2">
            <input wire:model.defer='nombre' type="text" class="form-control documento rounded-md"
                id="floatinDocumento" placeholder="Documento" name="documento"
