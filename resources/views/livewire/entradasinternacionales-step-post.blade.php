<div>
    <form wire:submit.prevent="registerEntradasI">
        {{-- Step 1 --}}
        @if ($currentStep == 1)
            <div class="step-one">
                <div class="card">
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-md">
                                <div class="form-floating mb-2">
                                    <input type="text" class="form-control matricula" id="floatinMatricula"
                                        wire:model='matricula' placeholder="MATRICULA" name="matricula" required />
                            ...
                            <div class="col-md">
                                <div class="form-floating mb-2">
                                    <input type="text" class="form-control nombre_emb" id="floatingNombreEmbarcacion"
                                        wire:model='nombre' placeholder="NOMBRE DE LA EMBARCACIÓN" name="nombre"
                                        required />
                            ...
                            <div class="col-md">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control numero_casco" id="floatingNumeroCasco"
                                        wire:model='numero_casco' placeholder="NUMERO DE CASCO" name="numero_casco"
                                        required />
                            ...
                            <div class="col-md">
                                <div class="form-floating">
                                    <input type="text" class="form-control color" id="floatingColor"
                                        wire:model='color' placeholder="COLOR DE LA EMBARCACIÓN" name="color"
                                        required />
                        ...
                        <div class="row g-2">
                            <div class="bg-blue-900 text-white text-sm font-medium mr-2 px-2.5 py-1.5 mb-1 rounded  dark:text-blue-300"
                                role="alert">
                                <div class="inline-block float-start">
                            ...
                            <div class="col-md">
                                <div class="form-floating mb-2">
                                    <input type="text" name="material_casco" class="form-control"
                                        id="floatingMaterial" placeholder="MATERIAL DEL CASCO" required
                                        wire:model='material_casco'>
                            ...
                            <div class="col-md">
                                <div class="form-floating mb-2">
                                    <input type="number" class="form-control eslora" id="floatinEslora"
                                        placeholder="ESLORA" name="eslora" required wire:model='eslora' />
                            ...
                            <div class="col-md">
                                <div class="form-floating mb-2">
                                    <input type="number" class="form-control nombre_emb" id="floatingManga"
                                        placeholder="MANGA" name="manga" required wire:model='manga' />
                            ...
                            <div class="col-md">
                                <div class="form-floating mb-3">
                                    <input type="number" class="form-control puntal" id="floatingPuntal"
                                        placeholder="PUNTAL" name="puntal" required wire:model='puntal' />
                            ...
                            <div class="col-md">
                                <div class="form-floating mb-2">
                                    <input type="text" name="tipo_motor" class="form-control"
                                        placeholder="TIPO MOTOR" required wire:model='tipo_motor'>
                            ...
                            <div class="col-md">
                                <div class="form-floating mb-2">
                                    <input type="text" name="marca_modelo_motor" class="form-control"
                                        placeholder="MARCA MOTOR" required wire:model='marca_modelo_motor'>
                            ...
                            <div class="col-md">
                                <div class="form-floating mb-2">
                                    <input type="text" name="caballos_fuerza_motor" class="form-control"
                                        placeholder="CABALLOS DE FUERZA" required wire:model='caballos_fuerza_motor'>
                            ...
                            <div class="col-md">
                                <div class="form-floating mb-2">
                                    <input type="text" name="no_motor" class="form-control"
                                        placeholder="CANTIDAD MOTOR" required wire:model='no_motor'>
        ...
        @if ($currentStep == 2)
            <div class="step-two">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="alert bg-blue-900 mt-2 text-white" role="alert">
                            ...
                            <div class="col-md">
                                <div class="form-floating mb-2">
                                    <input type="text" class="form-control nombre_capitan"
                                        ...
                                        value="" name="nombre_capitan" required wire:model='nombre_capitan' />
                            ...
                            <div class="col-md">
                                <div class="form-floating mb-2">
                                    <select name="nacionalidad_cap" class="form-select nacionalidad" id=""
                                        required wire:model='nacionalidad_cap'>
                                        <option value="">- Seleccione -</option>
                        ...
                        <div class="row">
                            <div class="col-md">
                                <div class="form-floating mb-2">
                                    <input type="text" class="form-control telefono"
                                        id="floatingNombreEmbarcacion" placeholder="TELÉFONO DEL CAPITÁN"
                                        name="telefono" required wire:model='telefono' />
                            ...
                            <div class="col-md">
                                <div class="form-floating mb-2">
                                    <input type="date" class="form-control" id="floatingFecha"
                            ...
                            <div class="col-md">
                                <div class="form-floating mb-2">
                                    <select name="pais_procedencia" id="" class="form-select" required
                                        ...
                                        <option value="Antillas holandesas" id="AN">Antillas holandesas
                                        </option>
                                        ...
                                        <option value="Bosnia y Herzegovina" id="BA">Bosnia y Herzegovina
                                        </option>
                                        ...
                                        <option value="Islas de Cocos o Keeling" id="CC">Islas de Cocos o
                                            Keeling
                                        </option>
                                        <option value="Islas Faroe" id="FO">Islas Faroe</option>
                                        <option value="Islas Fiyi" id="FJ">Islas Fiyi</option>
                                        <option value="Islas Malvinas Islas Falkland" id="FK">Islas Malvinas
                                            Islas
                                            Falkland</option>
                                        <option value="Islas Marianas del norte" id="MP">Islas Marianas del
                                            norte
                                        </option>
                                        <option value="Islas Marshall" id="MH">Islas Marshall</option>
                                        <option value="Islas menores de Estados Unidos" id="UM">Islas menores
                                            de
                                        ...
                                        <option value="Islas Turks y Caicos" id="TC">Islas Turks y Caicos
                                        </option>
                                        ...
                                        <option value="San Vicente e Islas Granadinas" id="VC">San Vicente e
                                            Islas
                                            Granadinas</option>
                                        ...
                                        <option value="Serbia y Montenegro" id="YU">Serbia y Montenegro
                                        </option>
                            ...
                            <div class="col-md">
                                <div class="form-floating mb-2">
                                    <input type="number" class="form-control cant-tripulante"
                                        ...
                                        name="cantidad_tripulantes" required wire:model='cantidad_tripulantes' />
                            ...
                            <div class="col-md">
                                <div class="form-floating mb-2">
                                    <input type="number" class="form-control cant-pasajero" id="floatinMatricula"
                                        ...
                                        name="cantidad_pasajeros" required wire:model='cantidad_pasajeros' />
            ...
            <div class="float-end">
                @if ($currentStep == 2 || $currentStep == 3)
                    <button type="button" wire:click='decreaseStep()'
                        class="inline-flex items-center px-3 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 focus:bg-gray-700 active:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150 ml-1">{{ __('Atras') }}</button>
                @endif
                @if ($currentStep == 1 || $currentStep == 2)
                    <button type="button" wire:click='increaseStep()'
                        class="inline-flex items-center justify-center px-4 py-2 bg-green-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-green-500 active:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transition ease-in-out duration-150 disabled:opacity-25 send">{{ __('Siguiente') }}</button>
                @endif
                @if ($currentStep == 3)
                    <button type="submit"
