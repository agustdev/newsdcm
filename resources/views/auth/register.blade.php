    ...
    <x-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4">
                ...
                <x-select id="tipo_documento" class="block mt-1 w-full tipo_documento" type="text" name="tipo_documento" :value="old('tipo_documento')" required />
            </div>

            <div class="mt-4">
                <x-label for="documento" value="{{ __('No documento') }}" />
                <x-input id="documento" class="block mt-1 w-full documento" type="text" name="documento" :value="old('documento')" required autofocus autocomplete="Cédula" />
            </div>

            <div>
                <x-label for="name" value="{{ __('Name') }}" />
                <x-input id="name" class="block mt-1 w-full nombre" type="text" name="name" :value="old('name')" required autocomplete="name" />
            </div>
            ...
            <div class="flex items-center justify-end mt-4">
                ...
                <x-button class="ml-4 disabled:opacity-25">
                    {{ __('Register') }}
                </x-button>
            </div>
        </form>
